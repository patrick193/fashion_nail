...
class ControllerPaymentPPExpress extends Controller {
    ...
    public function checkout(){
        ...
        if ($this->config->get('pp_express_test') == 1) {
            header('Location: https://www.sandbox.paypal.com/cgiÃ¢â‚¬â€˜bin/webscr?cmd=_express-checkout&token=' . $result['TOKEN'].'&useraction=commit');
        } else {
            header('Location: https://www.paypal.com/cgiÃ¢â‚¬â€˜bin/webscr?cmd=_express-checkout&token=' . $result['TOKEN'].'&useraction=commit');
        }
    }
